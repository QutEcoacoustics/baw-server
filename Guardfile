...
guard :rspec, cli: '--format progress --color --seed 3583' do
  ...
  watch(%r{^app/controllers/(.+)_(controller)\.rb$})   { |m| %W(spec/acceptance/#{m[1]}_spec.rb spec/controllers/#{m[1]}_controller_spec.rb) }
