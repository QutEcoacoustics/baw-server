...
resource 'AudioEventComments' do
  ...
  let!(:comment_writer) {
    AudioEventComment.where(creator: writer_user, audio_event:).first
  }
  let!(:comment_owner) {
    FactoryBot.create(
      :comment,
  ...
  get '/audio_events/:audio_event_id/comments' do
    ...
    standard_request_options(:get, 'LIST (as writer)', :ok,
      { expected_json_path: 'data/0/comment', data_item_count: 3 })
  end
  ...
  get '/audio_events/:audio_event_id/comments' do
    ...
    standard_request_options(:get, 'LIST (as other)', :forbidden,
  ...
  get '/audio_events/:audio_event_id/comments' do
    ...
    standard_request_options(:get, 'LIST (as other token, reader comment)', :forbidden,
      { expected_json_path: get_json_error_path(:permissions) })
  end
  ...
  get '/audio_events/:audio_event_id/comments' do
    ...
    standard_request_options(:get, 'LIST (invalid token)', :unauthorized,
  ...
  get '/audio_events/:audio_event_id/comments' do
    ...
    standard_request_options(:get, 'LIST (as anonymous user)', :unauthorized,
  ...
  post '/audio_events/:audio_event_id/comments' do
    ...
    standard_request_options(:post, 'CREATE (as other token)', :forbidden,
      { expected_json_path: get_json_error_path(:permissions) })
  end
  ...
  post '/audio_events/:audio_event_id/comments' do
    ...
    standard_request_options(:post, 'CREATE (invalid token)', :unauthorized,
      { expected_json_path: get_json_error_path(:sign_up) })
  end
  ...
  get '/audio_events/:audio_event_id/comments/:id' do
    ...
    standard_request_options(:get, 'SHOW (as other user)', :forbidden,
      { expected_json_path: get_json_error_path(:permissions) })
  end
  ...
  get '/audio_events/:audio_event_id/comments/:id' do
    ...
    standard_request_options(:get, 'SHOW (as other user showing writer comment)', :forbidden,
      { expected_json_path: get_json_error_path(:permissions) })
  end
  ...
  get '/audio_events/:audio_event_id/comments/:id' do
    ...
    standard_request_options(:get, 'SHOW (as writer showing other comment)', :ok,
      { expected_json_path: 'data/comment' })
  end
  ...
  put '/audio_events/:audio_event_id/comments/:id' do
    ...
    let(:raw_post) { { audio_event_comment: post_attributes }.to_json }
    let(:authentication_token) { owner_token }
    standard_request_options(:put, 'UPDATE (as owner)', :forbidden,
      { expected_json_path: get_json_error_path(:permissions) })
  end
  ...
  put '/audio_events/:audio_event_id/comments/:id' do
    ...
    let(:raw_post) { { audio_event_comment: post_attributes }.to_json }
    let(:authentication_token) { owner_token }
    standard_request_options(:put, 'UPDATE (as owner updating own comment)', :ok,
      { expected_json_path: 'data/comment' })
  end
  ...
  put '/audio_events/:audio_event_id/comments/:id' do
    ...
    let(:raw_post) { { audio_event_comment: post_attributes }.to_json }
    let(:authentication_token) { invalid_token }
    standard_request_options(:put, 'UPDATE (as invalid user)', :unauthorized,
      { expected_json_path: get_json_error_path(:sign_up) })
  end
  ...
  put '/audio_events/:audio_event_id/comments/:id' do
    ...
    let(:id) { comment_owner.id }
    let(:raw_post) { { audio_event_comment: post_attributes }.to_json }
    standard_request_options(:put, 'UPDATE (as anonymous user, owner comment)', :unauthorized,
      { remove_auth: true, expected_json_path: get_json_error_path(:sign_up) })
  end
  ...
  put '/audio_events/:audio_event_id/comments/:id' do
    ...
    let(:id) { comment_writer.id }
    let(:raw_post) { { audio_event_comment: post_attributes }.to_json }
    standard_request_options(:put, 'UPDATE (as anonymous user, writer comment)', :unauthorized,
      { remove_auth: true, expected_json_path: get_json_error_path(:sign_up) })
  end
  ...
  put '/audio_events/:audio_event_id/comments/:id' do
    ...
    let(:id) { comment_reader.id }
    let(:raw_post) { { audio_event_comment: post_attributes }.to_json }
    standard_request_options(:put, 'UPDATE (as anonymous user, reader comment)', :unauthorized,
      { remove_auth: true, expected_json_path: get_json_error_path(:sign_up) })
  end
  ...
  put '/audio_events/:audio_event_id/comments/:id' do
    ...
    let(:id) { comment_other.id }
    let(:raw_post) { { audio_event_comment: post_attributes }.to_json }
    standard_request_options(:put, 'UPDATE (as anonymous user, other comment)', :unauthorized,
      { remove_auth: true, expected_json_path: get_json_error_path(:sign_up) })
  end
  ...
  put '/audio_events/:audio_event_id/comments/:id' do
    ...
    let(:raw_post) { { audio_event_comment: post_attributes }.to_json }
    let(:authentication_token) { no_access_token }
    standard_request_options(:put, 'UPDATE (as other updating comment created by writer)', :forbidden,
      { expected_json_path: get_json_error_path(:permissions) })
  end
  ...
  put '/audio_events/:audio_event_id/comments/:id' do
    ...
    let(:authentication_token) { writer_token }
    standard_request_options(:put, 'UPDATE (as writer updating flag to report for comment created by writer)', :ok,
      { expected_json_path: 'data/flag', response_body_content: 'report' })
  end
  ...
  put '/audio_events/:audio_event_id/comments/:id' do
    ...
    let(:authentication_token) { writer_token }
    standard_request_options(:put, 'UPDATE (as writer updating flag to nil for comment created by writer)', :ok,
      { expected_json_path: 'data/flag', response_body_content: '"flag":null' })
  end
  ...
  delete '/audio_events/:audio_event_id/comments/:id' do
    ...
    standard_request_options(:delete, 'DESTROY (as owner destroying own comment)', :no_content,
      { expected_response_has_content: false, expected_response_content_type: nil })
  end
  ...
  delete '/audio_events/:audio_event_id/comments/:id' do
    ...
    standard_request_options(:delete, 'DESTROY (as no access user)', :forbidden,
      { expected_json_path: get_json_error_path(:permissions) })
  end
  ...
  delete '/audio_events/:audio_event_id/comments/:id' do
    ...
    standard_request_options(:delete, 'DESTROY (as other deleting comment created by writer)', :forbidden,
      { expected_json_path: get_json_error_path(:permissions) })
  end
  ...
  post '/audio_event_comments/filter' do
    ...
    standard_request_options(:post, 'FILTER (as reader)', :ok, {
      ...
      data_item_count: 4,
      response_body_content: ['"the owner comment text"', '"the reader comment text"',
                              '"the no access comment text"', '"comment":"comment text '],
