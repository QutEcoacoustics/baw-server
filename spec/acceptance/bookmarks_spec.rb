...
resource 'Bookmarks' do
  ...
  let(:post_attributes) { FactoryGirl.attributes_for(:bookmark, audio_recording_id: @bookmark.audio_recording_id) }
  ...
  post '/bookmarks' do
    ...
    standard_request('CREATE (as admin)', 201, 'offset_seconds', true)
  end
  ...
  post '/bookmarks' do
    ...
    standard_request('CREATE (as writer)', 201, 'offset_seconds', true)
  end
  ...
  post '/bookmarks' do
    ...
    standard_request('CREATE (as reader)', 201, 'offset_seconds', true)
  end
  ...
  post '/bookmarks' do
    ...
    standard_request('CREATE (as other user)', 403, 'meta/error/links/request permissions', true)
  end
  ...
  put '/bookmarks/:id' do
    ...
    let(:authentication_token) { reader_token }
    let(:id) { @bookmark.id }
    standard_request('UPDATE (as user)', 204, 'offset_seconds', true)
  end
