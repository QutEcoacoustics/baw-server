...
resource 'Permissions' do
  ...
  let!(:owner_user_2) { FactoryGirl.create(:user) }
  let!(:writer_user_2) { FactoryGirl.create(:user) }
  let!(:reader_user_2) { FactoryGirl.create(:user) }
  let!(:owner_permission_2) { FactoryGirl.create(:own_permission, creator: admin_user, user: owner_user_2) }
  let!(:project_2) { owner_permission_2.project }
  let!(:writer_permission_2) { FactoryGirl.create(:write_permission, creator: admin_user, user: writer_user_2, project: project_2) }
  let!(:reader_permission_2) { FactoryGirl.create(:read_permission, creator: admin_user, user: reader_user_2, project: project_2) }
