...
def tag_body_params
  ...
  parameter :type_of_tag, 'choose from [general, common_name, species_name, looks_like, sounds_like]', scope: :tag,
    required: true
...
resource 'Tags' do
  ...
  get '/audio_recordings/:audio_recording_id/audio_events/:audio_event_id/tags' do
    ...
    standard_request_options(:get, 'LIST for audio_event (as admin)', :ok,
      { expected_json_path: 'data/0/is_taxonomic', data_item_count: 1 })
  end
  ...
  get '/audio_recordings/:audio_recording_id/audio_events/:audio_event_id/tags' do
    ...
    standard_request_options(:get, 'LIST for audio_event (as owner)', :ok,
      { expected_json_path: 'data/0/is_taxonomic', data_item_count: 1 })
  end
  ...
  get '/audio_recordings/:audio_recording_id/audio_events/:audio_event_id/tags' do
    ...
    standard_request_options(:get, 'LIST for audio_event (as writer)', :ok,
      { expected_json_path: 'data/0/is_taxonomic', data_item_count: 1 })
  end
  ...
  get '/audio_recordings/:audio_recording_id/audio_events/:audio_event_id/tags' do
    ...
    standard_request_options(:get, 'LIST for audio_event (as reader)', :ok,
      { expected_json_path: 'data/0/is_taxonomic', data_item_count: 1 })
  end
  ...
  get '/audio_recordings/:audio_recording_id/audio_events/:audio_event_id/tags' do
    ...
    standard_request_options(:get, 'LIST for audio_event (as no access user)', :forbidden,
  ...
  get '/audio_recordings/:audio_recording_id/audio_events/:audio_event_id/tags' do
    ...
    standard_request_options(:get, 'LIST for audio_event (with invalid token)', :unauthorized,
      { expected_json_path: get_json_error_path(:sign_up) })
  end

  get '/audio_recordings/:audio_recording_id/audio_events/:audio_event_id/tags' do
    tag_extras_id_params
    standard_request_options(:get, 'LIST for audio_event (as anonymous user)', :unauthorized,
  ...
  get '/tags' do
    ...
    standard_request_options(:get, 'LIST for audio_event (as admin, shallow route)', :ok,
      { expected_json_path: 'data/0/is_taxonomic', data_item_count: 1 })
  end
  ...
  get '/tags' do
    ...
    standard_request_options(:get, 'LIST for audio_event (as owner, shallow route)', :ok,
      { expected_json_path: 'data/0/is_taxonomic', data_item_count: 1 })
  end
  ...
  get '/tags' do
    ...
    standard_request_options(:get, 'LIST for audio_event (as writer, shallow route)', :ok,
      { expected_json_path: 'data/0/is_taxonomic', data_item_count: 1 })
  end
  ...
  get '/tags' do
    ...
    standard_request_options(:get, 'LIST for audio_event (as reader, shallow route)', :ok,
      expected_json_path: 'data/0/is_taxonomic', data_item_count: 1)
  end
  ...
  get '/tags' do
    ...
    standard_request_options(:get, 'LIST for audio_event (has parameters, as reader, shallow route)', :ok,
  ...
  get '/tags' do
    ...
    standard_request_options(:get, 'LIST for audio_event (as no access user, shallow route)', :forbidden,
      { expected_json_path: get_json_error_path(:permissions) })
  end
  ...
  get '/tags' do
    ...
    standard_request_options(:get, 'LIST for audio_event (with invalid token, shallow route)', :unauthorized,
      { expected_json_path: get_json_error_path(:sign_up) })
  end

  get '/tags' do
    tag_extras_id_params
    standard_request_options(:get, 'LIST for audio_event (as anonymous user, shallow route)', :unauthorized,
      { remove_auth: true, expected_json_path: get_json_error_path(:sign_in) })
  end
  ...
  get '/tags/new' do
    ...
    standard_request_options(:get, 'NEW for audio_event (as no access user)', :ok,
      { expected_json_path: 'data/is_taxonomic' })
  end

  get '/tags/new' do
    let(:authentication_token) { invalid_token }

    standard_request_options(:get, 'NEW for audio_event (with invalid token)', :unauthorized,
      { expected_json_path: get_json_error_path(:sign_up) })
  end

  get '/tags/new' do
    standard_request_options(:get, 'NEW for audio_event (as anonymous user)', :unauthorized,
      { remove_auth: true, expected_json_path: get_json_error_path(:sign_in) })
  end
  ...
  get '/tags/:id' do
    tag_id_param
    standard_request_options(:get, 'SHOW (as anonymous user)', :ok,
      { remove_auth: true, expected_json_path: 'data/is_taxonomic' })
  end
