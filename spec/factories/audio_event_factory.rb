  ...
  factory :audio_event do
    ...
    trait :with_tags do
      ...
      after(:create) do |audio_event, evaluator|
        ...
        create_list(:tagging, evaluator.tag_count, audio_event: audio_event, creator: evaluator.creator)
      end
    end
    ...
    trait :with_comments do
      ...
      after(:create) do |audio_event, evaluator|
        raise 'Creator was blank' if  evaluator.creator.blank?
        create_list(:audio_event_comment, evaluator.comment_count, audio_event: audio_event, creator: evaluator.creator)
      end
    end
