...
describe 'reports/analysis_coverage' do
  ...
  # # Extend the RESULT_SUCCESS group with an additional recording
  # (recording_end_date(audio_recording) + gap_below_threshold)
  #   .then { |recorded_date| create(:audio_recording, creator: writer_user, site:, recorded_date:, duration_seconds:) }
  #   .then { |rec| create(:analysis_jobs_item, analysis_job:, script:, result: AnalysisJobsItem::RESULT_SUCCESS, audio_recording: rec) }
  # context 'with multiple sites' do
  #   let(:a_site) { create(:site, creator: writer_user, region: region, projects: [project]) }
  #   let(:a_site_rec) {
  #     create(:audio_recording, creator: writer_user, site: a_site, recorded_date: start_date, duration_seconds:)
  #   }
  #   let(:a_site_rec_2) {
  #     # Starts > gap threshold after previous recording ends: separate island
  #     create(:audio_recording,
  #       creator: writer_user, site: a_site, recorded_date: recording_end_date(a_site_rec) + gap_above_threshold, duration_seconds:)
  #   }
  ...
  #      {
  #        site_id: a_site.id,
  #        coverage: [a_site_rec.recorded_date.utc,
  #                   a_site_rec.recorded_date.utc + a_site_rec.duration_seconds],
  #        density: 1.0,
  #        gap_threshold:
  #      },
  #      {
  #        site_id: a_site.id,
  #        coverage: [a_site_rec_2.recorded_date.utc,
  #                   a_site_rec_2.recorded_date.utc + a_site_rec_2.duration_seconds],
  #        density: 1.0,
  #        gap_threshold:
  #      }]
  #   end
  ...
  #   before do
  #     create(:audio_recording, creator: writer_user, site: a_site, recorded_date: start_date, duration_seconds:)
  #     create(:audio_recording, creator: writer_user, site: a_site, recorded_date: start_date + 1.day, duration_seconds:)
  #   end

  #   let(:filter) { { filter: { site_id: { not_eq: a_site.id } } } }
