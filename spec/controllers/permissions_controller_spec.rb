...
#        post :create, {:permission => { "creator_id" => "invalid value" }}, valid_session
#        assigns(:permission).should be_a_new(Permission)
#      end
#
...
#        Permission.any_instance.should_receive(:update_attributes).with({ "creator_id" => "1" })
#        put :update, {:id => permission.to_param, :permission => { "creator_id" => "1" }}, valid_session
#      end
#
#      it "assigns the requested permission as @permission" do
#        permission = Permission.create! valid_attributes
...
#        # Trigger the behavior that occurs when invalid params are submitted
#        Permission.any_instance.stub(:save).and_return(false)
#        put :update, {:id => permission.to_param, :permission => { "creator_id" => "invalid value" }}, valid_session
#        assigns(:permission).should eq(permission)
#      end
#
