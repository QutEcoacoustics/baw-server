...
#  let(:valid_attributes) { { "audio_recording_id" => "1" } }
#
...
#        post :create, {:bookmark => { "audio_recording_id" => "invalid value" }}, valid_session
#        assigns(:bookmark).should be_a_new(Bookmark)
#      end
#
...
#        Bookmark.any_instance.should_receive(:update_attributes).with({ "audio_recording_id" => "1" })
#        put :update, {:id => bookmark.to_param, :bookmark => { "audio_recording_id" => "1" }}, valid_session
#      end
#
#      it "assigns the requested bookmark as @bookmark" do
#        bookmark = Bookmark.create! valid_attributes
...
#        # Trigger the behavior that occurs when invalid params are submitted
#        Bookmark.any_instance.stub(:save).and_return(false)
#        put :update, {:id => bookmark.to_param, :bookmark => { "audio_recording_id" => "invalid value" }}, valid_session
#        assigns(:bookmark).should eq(bookmark)
#      end
#
