            ...
            items: {
              ...
              properties: {
                ...
                detected_manual_minutes: { type: 'integer',
                                           description: 'The number of minutes containing at least one annotation with this tag that was manually annotated or manually
																					 imported. Here, "manual" describes how the annotation entered the system, not how the detection was produced; imported annotations
																					 may contain detections generated by offline analyses.' },
