...
describe AudioRecordingsController do
  describe :routing do
    ...
    it { expect(get('/projects/1/sites/2/audio_recordings')).to route_to('audio_recordings#index', project_id: '1', site_id: '2', format: 'json') }
    ...
    it { expect(get('/projects/1/sites/2/audio_recordings/3')).to route_to('audio_recordings#show', project_id: '1', site_id: '2', id: '3', format: 'json') }
