...
describe AudioRecordingsController do
  describe :routing do
    ...
    it { expect(get('/projects/1/sites/2/audio_recordings')).to route_to('errors#routing', requested_route: 'projects/1/sites/2/audio_recordings') }
    ...
    it { expect(get('/projects/1/sites/2/audio_recordings/new')).to route_to('errors#routing', requested_route: 'projects/1/sites/2/audio_recordings/new') }
    it { expect(get('/projects/1/sites/2/audio_recordings/3')).to route_to('errors#routing', requested_route:'projects/1/sites/2/audio_recordings/3' ) }
