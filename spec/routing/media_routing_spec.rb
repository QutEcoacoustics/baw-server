...
describe MediaController do
  describe :routing do
    ...
    it { expect(get('/projects/1/sites/2/audio_recordings/3/media.json')).to route_to('errors#routing', requested_route: 'projects/1/sites/2/audio_recordings/3/media', format: 'json') }
    it { expect(get('/projects/1/sites/2/audio_recordings/3/media.png')).to route_to('errors#routing', requested_route: 'projects/1/sites/2/audio_recordings/3/media', format: 'png') }
    it { expect(get('/projects/1/sites/2/audio_recordings/3/media.mp3')).to route_to('errors#routing', requested_route: 'projects/1/sites/2/audio_recordings/3/media', format: 'mp3') }
