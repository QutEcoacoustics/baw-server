  ...
  module Export
    module CamtrapDp
      class Observation < ::Dry::Struct
        ...
        attribute :eventEnd, ::BawApp::Types::UtcTime
        ...
        attribute :eventStart, ::BawApp::Types::UtcTime
        ...
        # ! TODO We could use score here but it isn't scaled 0-1. And there is no place for verification consensus currently.
        ...
        attribute? :classificationTimestamp, ::BawApp::Types::UtcTime.optional
