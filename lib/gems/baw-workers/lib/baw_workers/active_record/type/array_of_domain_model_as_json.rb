...
module BawWorkers
  module ActiveRecord
    module Type
      ...
      class ArrayOfDomainModelAsJson < ::ActiveRecord::Type::Json
        ...
        def deserialize(value)
          ...
          raise "A non-array (#{deserialized}) was provided to mappings" unless deserialized.is_a?(Array)

          deserialized.map { |x| target_class.new(x) }
        end
