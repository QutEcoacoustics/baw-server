...
module Report
  module Section
    ...
    module Composition
      ...
      TABLES = {
        composition_series: TABLE_COMPOSITION_SERIES
      }.freeze
      ...
      step table: TABLE_COMPOSITION_SERIES, as: proc { |_t, options|
      ...
      def project(_collection = nil, _options = nil)
        composition_series_aliased = TABLE_COMPOSITION_SERIES.as('c')
        Arel::SelectManager.new
