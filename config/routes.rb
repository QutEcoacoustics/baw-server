...
#                                  filter_user_accounts GET|POST                                     /user_accounts/filter(.:format)                                                                                                      user_accounts#filter {:format=>"json"}
...
#                                      filter_bookmarks GET|POST                                     /bookmarks/filter(.:format)                                                                                                          bookmarks#filter {:format=>"json"}
...
#                            filter_project_permissions GET|POST                                     /projects/:project_id/permissions/filter(.:format)                                                                                   permissions#filter {:format=>"json"}
...
#                  filter_project_site_audio_recordings GET|POST                                     /projects/:project_id/sites/:site_id/audio_recordings/filter(.:format)                                                               audio_recordings#filter {:format=>"json"}
...
#                                  filter_project_sites GET|POST                                     /projects/:project_id/sites/filter(.:format)                                                                                         sites#filter {:format=>"json"}
...
#                                filter_project_regions GET|POST                                     /projects/:project_id/regions/filter(.:format)                                                                                       regions#filter {:format=>"json"}
...
#                               filter_project_harvests GET|POST                                     /projects/:project_id/harvests/filter(.:format)                                                                                      harvests#filter {:format=>"json"}
...
#                                       filter_projects GET|POST                                     /projects/filter(.:format)                                                                                                           projects#filter {:format=>"json"}
...
#                         analysis_jobs_results_results GET|HEAD                                     /analysis_jobs/:analysis_job_id/results(/*results_path)                                                                              analysis_jobs_results#results {:format=>"json"}
#                       analysis_jobs_results_artifacts GET|HEAD                                     /analysis_jobs/:analysis_job_id/artifacts(/*results_path)                                                                            analysis_jobs_results#artifacts {:format=>"json"}
#                                   invoke_analysis_job POST|PUT                                     /analysis_jobs/:id/:invoke_action(.:format)                                                                                          analysis_jobs#invoke {:format=>"json"}
#                             filter_analysis_job_items GET|POST                                     /analysis_jobs/:analysis_job_id/items/filter(.:format)                                                                               analysis_jobs_items#filter {:format=>"json"}
#                              invoke_analysis_job_item POST|PUT                                     /analysis_jobs/:analysis_job_id/items/:id/:invoke_action(.:format)                                                                   analysis_jobs_items#invoke {:format=>"json"}
...
#                                  filter_analysis_jobs GET|POST                                     /analysis_jobs/filter(.:format)                                                                                                      analysis_jobs#filter {:format=>"json"}
...
#                                 filter_saved_searches GET|POST                                     /saved_searches/filter(.:format)                                                                                                     saved_searches#filter {:format=>"json"}
...
#      filter_audio_recording_audio_event_verifications GET|POST                                     /audio_recordings/:audio_recording_id/audio_events/:audio_event_id/verifications/filter(.:format)                                    verifications#filter {:format=>"json"}
#             audio_recording_audio_event_verifications GET                                          /audio_recordings/:audio_recording_id/audio_events/:audio_event_id/verifications(.:format)                                           verifications#index {:format=>"json"}
#              audio_recording_audio_event_verification GET                                          /audio_recordings/:audio_recording_id/audio_events/:audio_event_id/verifications/:id(.:format)                                       verifications#show {:format=>"json"}
#                   filter_audio_recording_audio_events GET|POST                                     /audio_recordings/:audio_recording_id/audio_events/filter(.:format)                                                                  audio_events#filter {:format=>"json"}
...
#                               filter_audio_recordings GET|POST                                     /audio_recordings/filter(.:format)                                                                                                   audio_recordings#filter {:format=>"json"}
...
#                                                       GET|POST                                     /audio_recordings/filter(.:format)                                                                                                   audio_recordings#filter {:format=>"json"}
#                                           filter_tags GET|POST                                     /tags/filter(.:format)                                                                                                               tags#filter {:format=>"json"}
...
#                          filter_shallow_verifications GET|POST                                     /verifications/filter(.:format)                                                                                                      verifications#filter {:format=>"json"}
#                                                       PUT                                          /verifications(.:format)                                                                                                             verifications#create_or_update {:format=>"json"}
#                                 shallow_verifications GET                                          /verifications(.:format)                                                                                                             verifications#index {:format=>"json"}
#                                                       POST                                         /verifications(.:format)                                                                                                             verifications#create {:format=>"json"}
#                              new_shallow_verification GET                                          /verifications/new(.:format)                                                                                                         verifications#new {:format=>"json"}
#                                  shallow_verification GET                                          /verifications/:id(.:format)                                                                                                         verifications#show {:format=>"json"}
#                                                       PATCH                                        /verifications/:id(.:format)                                                                                                         verifications#update {:format=>"json"}
#                                                       PUT                                          /verifications/:id(.:format)                                                                                                         verifications#update {:format=>"json"}
#                                                       DELETE                                       /verifications/:id(.:format)                                                                                                         verifications#destroy {:format=>"json"}
#                           filter_audio_event_comments GET|POST                                     /audio_events/:audio_event_id/comments/filter(.:format)                                                                              audio_event_comments#filter {:format=>"json"}
...
#                                   filter_audio_events GET|POST                                     /audio_events/filter(.:format)                                                                                                       audio_events#filter {:format=>"json"}
#                                    filter_provenances GET|POST                                     /provenances/filter(.:format)                                                                                                        provenances#filter {:format=>"json"}
...
#                       filter_audio_event_import_files GET|POST                                     /audio_event_imports/:audio_event_import_id/files/filter(.:format)                                                                   audio_event_import_files#filter {:format=>"json"}
#                              audio_event_import_files GET                                          /audio_event_imports/:audio_event_import_id/files(.:format)                                                                          audio_event_import_files#index {:format=>"json"}
#                                                       POST                                         /audio_event_imports/:audio_event_import_id/files(.:format)                                                                          audio_event_import_files#create {:format=>"json"}
#                           new_audio_event_import_file GET                                          /audio_event_imports/:audio_event_import_id/files/new(.:format)                                                                      audio_event_import_files#new {:format=>"json"}
#                               audio_event_import_file GET                                          /audio_event_imports/:audio_event_import_id/files/:id(.:format)                                                                      audio_event_import_files#show {:format=>"json"}
#                                                       DELETE                                       /audio_event_imports/:audio_event_import_id/files/:id(.:format)                                                                      audio_event_import_files#destroy {:format=>"json"}
#                            filter_audio_event_imports GET|POST                                     /audio_event_imports/filter(.:format)                                                                                                audio_event_imports#filter {:format=>"json"}
#                destroy_permanently_audio_event_import POST|DELETE                                  /audio_event_imports/:id/destroy(.:format)                                                                                           audio_event_imports#destroy_permanently {:format=>"json"}
#                            recover_audio_event_import POST                                         /audio_event_imports/:id/recover(.:format)                                                                                           audio_event_imports#recover {:format=>"json"}
...
#                                        filter_scripts GET|POST                                     /scripts/filter(.:format)                                                                                                            scripts#filter {:format=>"json"}
...
#                          download_region_audio_events GET                                          /projects/:project_id/regions/:region_id/audio_events/download(.:format)                                                             audio_events#download {:format=>"csv"}
...
#                             filter_shallow_site_index GET|POST                                     /sites/filter(.:format)                                                                                                              sites#filter {:format=>"json"}
...
#                           filter_shallow_region_index GET|POST                                     /regions/filter(.:format)                                                                                                            regions#filter {:format=>"json"}
...
#                                  filter_harvest_index GET|POST                                     /harvests/filter(.:format)                                                                                                           harvests#filter {:format=>"json"}
...
#                                  filter_dataset_items GET|POST                                     /datasets/:dataset_id/items/filter(.:format)                                                                                         dataset_items#filter {:format=>"json"}
...
#                                       filter_datasets GET|POST                                     /datasets/filter(.:format)                                                                                                           datasets#filter {:format=>"json"}
...
#                                        filter_studies GET|POST                                     /studies/filter(.:format)                                                                                                            studies#filter {:format=>"json"}
...
#                                      filter_questions GET|POST                                     /questions/filter(.:format)                                                                                                          questions#filter {:format=>"json"}
...
#                                      filter_responses GET|POST                                     /responses/filter(.:format)                                                                                                          responses#filter {:format=>"json"}
...
#                                filter_progress_events GET|POST                                     /progress_events/filter(.:format)                                                                                                    progress_events#filter {:format=>"json"}
...
#                                                                                                    /job_queue_status                                                                                                                    #<Resque::Server app_file="/usr/local/bundle/gems/resque-2.6.0/lib/resque/server.rb">
